  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { titleKey: 'routes.agents', icon: 'PeopleOutline', gateway: 'openclaw', hidden: true },
      },
      {
        path: 'office',
        name: 'Office',
      ...
      },
      {
        ...
        meta: { titleKey: 'routes.myworld', icon: 'StorefrontOutline', gateway: 'openclaw', hidden: true },
      },
      {
        path: 'backup',
        name: 'Backup',
