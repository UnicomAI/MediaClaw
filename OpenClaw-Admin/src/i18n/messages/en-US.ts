export default {
  ...
  pages: {
    ...
    plugins: {
      title: 'Plugins',
      info: 'Manage OpenClaw Gateway plugin configurations. Changes require save and apply to take effect.',
      loadFailed: 'Failed to load plugin data: {error}',
      ...
      savedAndApplied: 'Configuration saved and applied',
      pendingUpdate: 'Pending Update',
      secretPlaceholder: 'Enter new value (leave empty to keep current)',
      genericConfigHint: 'This plugin uses generic configuration format. Please configure via openclaw.json directly.',
      status: {
      ...
      mediaclaw: {
        label: 'MediaClaw Multimodal',
        description: 'Media generation capabilities from YuanJing AI team: text-to-image, text-to-video, speech synthesis, digital avatar, and more.',
        providers: {
        ...
        capabilities: {
          ...
          description: 'Configure provider and model options for each capability. Unconfigured capabilities will use the default provider.',
          ...
          videoModelWan: 'Wan 2.2',
          videoModelKling: 'Kling V3',
        },
        global: {
          title: 'Global Settings',
          defaultProvider: 'Default Provider',
          outputDir: 'Output Directory',
          videoPollInterval: 'Video Poll Interval (ms)',
          videoMaxWaitTime: 'Video Max Wait Time (ms)',
        },
      },
    },
    config: {
